...
import com.wa.toolkit.adapter.RecordingsAdapter;
import com.wa.toolkit.databinding.FragmentRecordingsBinding;
import com.wa.toolkit.model.Recording;
import com.wa.toolkit.ui.dialogs.AudioPlayerDialog;
...
public class RecordingsFragment extends Fragment implements RecordingsAdapter.OnRecordingActionListener {
    ...
    private void initializeBaseDirs() {
        ...
        // 5. Legacy fallback
        addBaseDir(addedPaths, new File(Environment.getExternalStorageDirectory(), "Music/WhatsappToolkit/Recordings"));
    }
