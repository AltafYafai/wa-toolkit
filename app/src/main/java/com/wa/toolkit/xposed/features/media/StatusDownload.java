...
import static com.wa.toolkit.xposed.features.listeners.MenuStatusListener.menuStatuses;
...
import com.wa.toolkit.xposed.utils.MimeTypeUtils;
    ...
    private void sharedStatus(FMessageWpp fMessageWpp) {
        try {
            ...
            try {
                ...
                XposedBridge
                        .log("WhatsappToolkit: FileProvider failed for " + file.getAbsolutePath() + ": " + e.getMessage());
            ...
            XposedBridge.log("WhatsappToolkit: sharedStatus error: " + e.getMessage());
