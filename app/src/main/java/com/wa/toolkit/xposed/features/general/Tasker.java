...
public class Tasker extends Feature {
    ...
    private void registerSenderMessage() {
        IntentFilter filter = new IntentFilter("com.wa.toolkit.MESSAGE_SENT");
    ...
    public synchronized static void sendTaskerEvent(String name, String number, String event) {
        ...
        Intent intent = new Intent("com.wa.toolkit.EVENT");
        ...
        com.wa.toolkit.xposed.core.FeatureManager.safeHookMethod(method, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                ...
                new Handler(Utils.getApplication().getMainLooper()).post(() -> {
                    Intent intent = new Intent("com.wa.toolkit.MESSAGE_RECEIVED");
                    intent.putExtra("number", number);
                    intent.putExtra("name", name);
